    ...
    return (
        <>
            ...
            <div className="relative group w-full flex-1 transition-all duration-500 ease-in-out">
                <label
                    className="block text-xs text-left font-semibold text-slate-500 uppercase tracking-wider mb-1.5 ml-1">
                    Departure
                </label>
                <TextField
                    aria-label="from"
    ...
    `}
            >
                ...
                <div className="min-w-[150px]">
                    <label
                        className="block text-xs text-left font-semibold text-slate-500 uppercase tracking-wider mb-1.5 ml-1 whitespace-nowrap">
                        Return
                    </label>
                    <TextField
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex gap-1">
                                ...
                                <div
                                    className="w-8 h-8 rounded bg-teal-500 text-white flex items-center justify-center text-xs font-bold">
                                    £
                                </div>
                                <div
                                    className="w-8 h-8 rounded bg-orange-400 text-white flex items-center justify-center text-xs font-bold">
                                    ££
                                </div>
                                <div
                                    className="w-8 h-8 rounded bg-rose-500 text-white flex items-center justify-center text-xs font-bold">
                                    £££
                                </div>
                            </div>
